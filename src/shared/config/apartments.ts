...
export const APARTMENTS_DATA: Apartment[] = [
  { id: 1, area: 45, rooms: 1, address: 'Астана, ул. Абая, 10', image: '/images/apt1.jpg' },
  { id: 2, area: 50, rooms: 1, address: 'Астана, ул. Сейфуллина, 5', image: '/images/apt2.jpg' },
  {
    id: 3,
    area: 80,
    rooms: 2,
  ...
  { id: 4, area: 60, rooms: 2, address: 'Астана, ул. Пушкина, 20', image: '/images/apt4.jpg' },
  { id: 5, area: 75, rooms: 2, address: 'Астана, ул. Кунаева, 8', image: '/images/apt5.jpg' },
  { id: 6, area: 90, rooms: 3, address: 'Астана, пр. Тәуелсіздік, 30', image: '/images/apt6.jpg' },
  {
    id: 7,
    area: 110,
    rooms: 3,
  ...
  { id: 8, area: 120, rooms: 4, address: 'Астана, пр. Республики, 45', image: '/images/apt8.jpg' },
  { id: 9, area: 100, rooms: 3, address: 'Астана, ул. Достык, 17', image: '/images/apt9.jpg' },
  { id: 10, area: 130, rooms: 4, address: 'Астана, ул. Сарыарқа, 33', image: '/images/apt10.jpg' },
  { id: 11, area: 140, rooms: 4, address: 'Астана, ул. Валиханова, 6', image: '/images/apt11.jpg' },
  {
    id: 12,
    area: 55,
    rooms: 2,
